...
describe('Screenshot Machine', function () {
  ...
  describe('initialize', function () {
    ...
    it('with options should set default options', function () {
      ...
      ssm.options.key.should.equal('12345');
      ssm.options.timeout.should.equal(0);
      ssm.options.cacheLimit.should.equal(0);
      ssm.options.size.should.equal('F');
      ssm.options.format.should.equal('JPG');
    ...
    it('with no options should not set any options', function () {
      ...
      should.not.exist(ssm.options.timeout);
      should.not.exist(ssm.options.cacheLimit);
      should.not.exist(ssm.options.size);
      should.not.exist(ssm.options.format);
      should.not.exist(ssm.options.hash);
    });
  });
